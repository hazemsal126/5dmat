...
<script type='text/javascript' src='https://www.bing.com/api/maps/mapcontrol?callback=GetMap&setMkt=ar-SA&setLang=ar&key=AjQ5Z3H5qH0tPqW7Hkbb0mFWPjmiXlhK5kC6ThaA9xYBf_duNLPfhqRTY5j46cVV ' async defer></script>
<script>
    var map;
    function GetMap() {
...
<div class="profile_left_content">
    <h2 class="plc_title">إضافة عنوان جديد</h2>
    <div class="white_box_st1 border0">
        <div class="address_whblock">
            <div class="row">
                <div class="col-lg-7">
                    <h3>يرجى إضافة في عنوان الشحن الخاص بك</h3>
                <form class="form_st2" method="POST" action="{{route('Addresses.index')}}">
                        @csrf
                        @if($errors->count())
                        <div class="clearfix">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    {{Form::select('country',$countries,NULL,["class"=>'form-control','placeholder' => 'Select a country'])}}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    {{Form::select('state',[],NULL,["class"=>'form-control','placeholder' => 'Select a state'])}}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    {{Form::select('city',[],NULL,["class"=>'form-control','placeholder' => 'Select a city'])}}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" name="geolocation" value="{{old('geolocation')}}" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">

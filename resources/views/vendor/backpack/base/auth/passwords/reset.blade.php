            ...
            <div class="container">
                <div class="row justify-content-md-center">
                    <div class="col-lg-5 col-md-7">
                        ...
                        @else
                            <h2 class="title_reg">Reset Password</h2>
                            <form class="form_st1" method="POST" action="{{ route('backpack.auth.password.reset') }}">
                                {!! csrf_field() !!}
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                            ...
                                            <input type="email" class="form-control" name="email" value="{{ $email ?? old('email') }}" placeholder="البريد الالكتروني">
                                            @if ($errors->has('email'))
                        ...
                        <div class="reg_bottom">
                            <h3><a href="#">عودة للصفحة الرئيسية</a></h3>
                        </div>
                    </div>
                </div>
            </div>
